...
namespace Dyna
{
	...
	{
		createGraphcicsPipeline(vertFilepath, fragFilepath, configInfo);
	}
	Pipeline::~Pipeline()
	{
		vkDestroyShaderModule(currentDevice.device(), vertShaderModule, nullptr);
		vkDestroyShaderModule(currentDevice.device(), fragShaderModule, nullptr);
	...
	void Pipeline::createGraphcicsPipeline(const std::string& vertFilepath, const std::string& fragFilepath, const PipelineConfigInfo& configInfo)
	{
		...
		if (vkCreateGraphicsPipelines(currentDevice.device(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline) != VK_SUCCESS)
		{
	...
	void Pipeline::createShaderModule(const std::vector<char>& code, VkShaderModule* shaderModule)
	{
		...
		if (vkCreateShaderModule(currentDevice.device(), &createInfo, nullptr, shaderModule) != VK_SUCCESS)
		{
